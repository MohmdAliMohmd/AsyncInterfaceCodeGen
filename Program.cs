...
//                            IsIdentity = false, // Will be updated later
...
//                        SELECT COLUMN_NAME
//                        FROM sys.columns
//                        WHERE object_id = OBJECT_ID('[{tableSchema}].[{tableName}]') AND is_identity = 1";
...
//                        while (reader.Read())
//                        {
//                            string idColumnName = reader["COLUMN_NAME"].ToString();
//                            foreach (var col in table.Columns)
//                            {
//                                if (col.Name == idColumnName) col.IsIdentity = true;
//                            }
//                        }
//                    }
...
//            // Generate DTO interfaces and classes
...
//            GenerateProjectFile(consolePath, "ConsoleApp.csproj", "Exe", "BLL", "DAL", "DTO");
...
//        {
//            string dtoInterfaceName = $"I{table.Name}DTO";
//            string dtoClassName = $"{table.Name}DTO";
//            string fileName = Path.Combine(path, $"{dtoClassName}.cs");
...
//            sb.AppendLine("{");
//            sb.AppendLine($"    public interface {dtoInterfaceName}");
//            sb.AppendLine("    {");

//            foreach (var col in table.Columns)
//            {
//                string nullableSymbol = col.IsNullable && col.DataType != "string" && col.DataType != "byte[]" ? "?" : "";
//                sb.AppendLine($"        {col.DataType}{nullableSymbol} {col.Name} {{ get; set; }}");
//            }

//            sb.AppendLine("    }");
//            sb.AppendLine();
//            sb.AppendLine($"    public class {dtoClassName} : {dtoInterfaceName}");
//            sb.AppendLine("    {");
...
//        {
//            string repoInterfaceName = $"I{table.Name}Repository";
//            string repoClassName = $"{table.Name}Repository";
//            string dtoInterfaceName = $"I{table.Name}DTO";
//            string dtoClassName = $"{table.Name}DTO";
//            string fileName = Path.Combine(path, $"{repoClassName}.cs");
...
//            sb.AppendLine("    {");
//            sb.AppendLine($"        Task<List<{dtoInterfaceName}>> GetAll{table.Name}sAsync();");

//            var pkColumns = table.Columns.Where(c => c.IsPrimary).ToList();
//            if (pkColumns.Any())
//            {
//                var pkColumn = pkColumns.First(); // Assuming single primary key for simplicity
//                string nullableSymbol = pkColumn.IsNullable && pkColumn.DataType != "string" && pkColumn.DataType != "byte[]" ? "?" : "";
//                sb.AppendLine($"        Task<{dtoInterfaceName}> Get{table.Name}ByIdAsync({pkColumn.DataType}{nullableSymbol} id);");
//            }

//            sb.AppendLine($"        Task Add{table.Name}Async({dtoInterfaceName} item);");

//            if (pkColumns.Any())
//            {
//                sb.AppendLine($"        Task Update{table.Name}Async({dtoInterfaceName} item);");
//                var pkColumn = pkColumns.First();
//                string nullableSymbol = pkColumn.IsNullable && pkColumn.DataType != "string" && pkColumn.DataType != "byte[]" ? "?" : "";
//                sb.AppendLine($"        Task Delete{table.Name}Async({pkColumn.DataType}{nullableSymbol} id);");
//            }
...
//            sb.AppendLine();
//            sb.AppendLine($"        public {repoClassName}(string connectionString)");
//            sb.AppendLine("        {");
...
//            // GetAll method
//            sb.AppendLine($"        public async Task<List<{dtoInterfaceName}>> GetAll{table.Name}sAsync()");
//            sb.AppendLine("        {");
//            sb.AppendLine($"            var list = new List<{dtoInterfaceName}>();");
...
//            sb.AppendLine("                        {");
//            sb.AppendLine($"                            var item = new {dtoClassName}");
//            sb.AppendLine("                            {");
//            foreach (var col in table.Columns)
//            {
//                string readerMethod = GetReaderMethod(col.DataType);
//                string cast = col.DataType == "byte[]" ? "(byte[])" : "";
//                string ordinal = $"reader.GetOrdinal(\"{col.Name}\")";
//                if (col.IsNullable)
//                {
//                    sb.AppendLine($"                                {col.Name} = reader.IsDBNull({ordinal}) ? null : {cast}reader.{readerMethod}({ordinal}),");
//                }
//                else
//                {
//                    sb.AppendLine($"                                {col.Name} = {cast}reader.{readerMethod}({ordinal}),");
//                }
//            }
//            sb.AppendLine("                            };");
...
//                sb.AppendLine($"        public async Task<{dtoInterfaceName}> Get{table.Name}ByIdAsync({pkColumn.DataType}{nullableSymbol} id)");
//                sb.AppendLine("        {");
//                sb.AppendLine($"            using (SqlConnection conn = new SqlConnection(_connectionString))");
//                sb.AppendLine("            {");
...
//                sb.AppendLine("                using (SqlCommand cmd = new SqlCommand(query, conn))");
//                sb.AppendLine("                {");
//                sb.AppendLine($"                    cmd.Parameters.AddWithValue(\"@Id\", id ?? (object)DBNull.Value);");
//                sb.AppendLine("                    await conn.OpenAsync();");
//                sb.AppendLine("                    using (SqlDataReader reader = await cmd.ExecuteReaderAsync())");
//                sb.AppendLine("                    {");
...
//            // Add method
//            sb.AppendLine($"        public async Task Add{table.Name}Async({dtoInterfaceName} item)");
//            sb.AppendLine("        {");
//            sb.AppendLine("            using (SqlConnection conn = new SqlConnection(_connectionString))");
//            sb.AppendLine("            {");
...
//            if (pkColumns.Any())
//            {
//                var pkColumn = pkColumns.First(); // Assuming single PK for simplicity

//                sb.AppendLine($"        public async Task Update{table.Name}Async({dtoInterfaceName} item)");
//                sb.AppendLine("        {");
//                sb.AppendLine("            using (SqlConnection conn = new SqlConnection(_connectionString))");
//                sb.AppendLine("            {");
...
//                foreach (var col in table.Columns)
//                {
//                    if (col.IsPrimary || col.IsIdentity) continue;
...
//                    sb.AppendLine($"                    cmd.Parameters.AddWithValue(\"@{col.Name}\", (object)item.{col.Name} ?? DBNull.Value);");
//                }
//                sb.AppendLine($"                    cmd.Parameters.AddWithValue(\"@{pkColumn.Name}\", (object)item.{pkColumn.Name} ?? DBNull.Value);");
...
//                sb.AppendLine($"        public async Task Delete{table.Name}Async({pkColumn.DataType}{nullableSymbol} id)");
//                sb.AppendLine("        {");
//                sb.AppendLine("            using (SqlConnection conn = new SqlConnection(_connectionString))");
//                sb.AppendLine("            {");
...
//        {
//            string serviceInterfaceName = $"I{table.Name}Service";
//            string serviceClassName = $"{table.Name}Service";
//            string dtoInterfaceName = $"I{table.Name}DTO";
//            string repoInterfaceName = $"I{table.Name}Repository";
//            string fileName = Path.Combine(path, $"{serviceClassName}.cs");
...
//            sb.AppendLine("{");
//            sb.AppendLine($"    public interface {serviceInterfaceName}");
//            sb.AppendLine("    {");
//            sb.AppendLine($"        Task<List<{dtoInterfaceName}>> GetAll{table.Name}sAsync();");
...
//            sb.AppendLine("    }");
//            sb.AppendLine();
//            sb.AppendLine($"    public class {serviceClassName} : {serviceInterfaceName}");
//            sb.AppendLine("    {");
//            sb.AppendLine($"        private readonly {repoInterfaceName} _repository;");
//            sb.AppendLine();
//            sb.AppendLine($"        public {serviceClassName}({repoInterfaceName} repository)");
//            sb.AppendLine("        {");
...
//            foreach (var table in tables)
//            {
//                sb.AppendLine($"            tableServices[\"{table.Name}\"] = new {table.Name}Service(new {table.Name}Repository(connectionString));");
...
//                    sb.AppendLine($"                        IsIdentity = {(col.IsIdentity ? "true" : "false")}");
//                    sb.AppendLine("                    },");
//                }
//                sb.AppendLine("                }");
//                sb.AppendLine("            };");
...
//            sb.AppendLine("            }");
//            sb.AppendLine("            Console.WriteLine();");
//            sb.AppendLine("            Console.WriteLine(new string('-', schema.Columns.Sum(c => 20)));");
//            sb.AppendLine();
...
//            sb.AppendLine("                dynamic id = string.IsNullOrEmpty(input) ? null : Convert.ChangeType(input, targetType);");
//            sb.AppendLine();
...
//            sb.AppendLine("            foreach (var col in schema.Columns)");
//            sb.AppendLine("            {");
//            sb.AppendLine("                // Skip auto-incrementing identity columns for input");
...
//            sb.AppendLine("                dynamic id = string.IsNullOrEmpty(idInput) ? null : Convert.ChangeType(idInput, pkType);");
//            sb.AppendLine();
...
//            sb.AppendLine("                foreach (var col in schema.Columns)");
//            sb.AppendLine("                {");
//            sb.AppendLine("                    if (col.IsPrimary || col.IsIdentity) continue; // Cannot update primary key or identity");
//            sb.AppendLine();
...
//            sb.AppendLine("                        if (string.IsNullOrWhiteSpace(input))");
//            sb.AppendLine("                        {");
//            sb.AppendLine("                            // Keep current value or set null if nullable and intended");
//            sb.AppendLine("                            if (col.IsNullable && defaultValue == \"\")");
//            sb.AppendLine("                            {");
//            sb.AppendLine("                                prop.SetValue(existingItem, null);");
//            sb.AppendLine("                            }");
//            sb.AppendLine("                            // else keep current");
//            sb.AppendLine("                            break;");
//            sb.AppendLine("                        }");
//            sb.AppendLine();
//            sb.AppendLine("                        try");
...
//            sb.AppendLine("            public bool IsIdentity { get; set; }");
//            sb.AppendLine("        }");
//            sb.AppendLine("    }");
//            sb.AppendLine("}");
...
//            // Add projects
//            AddProjectToSolution(sb, "DTO", Path.Combine("DTO", "DTO.csproj"), projectGuids["DTO"]);
//            AddProjectToSolution(sb, "DAL", Path.Combine("DAL", "DAL.csproj"), projectGuids["DAL"]);
//            AddProjectToSolution(sb, "BLL", Path.Combine("BLL", "BLL.csproj"), projectGuids["BLL"]);
//            AddProjectToSolution(sb, "ConsoleApp", Path.Combine("ConsoleApp", "ConsoleApp.csproj"), projectGuids["ConsoleApp"]);
...
//            AddProjectConfig(sb, "DTO", projectGuids["DTO"]);
//            AddProjectConfig(sb, "DAL", projectGuids["DAL"]);
//            AddProjectConfig(sb, "BLL", projectGuids["BLL"]);
//            AddProjectConfig(sb, "ConsoleApp", projectGuids["ConsoleApp"]);
//            sb.AppendLine("\tEndGlobalSection");
...
//        static void AddProjectConfig(StringBuilder sb, string projectName, Guid projectGuid)
//        {
//            string[] configs = { "Debug|Any CPU", "Release|Any CPU" };
//            foreach (var config in configs)
//            {
//                sb.AppendLine($"\t\t{{{projectGuid}}}.{config}.ActiveCfg = {config}");
//                sb.AppendLine($"\t\t{{{projectGuid}}}.{config}.Build.0 = {config}");
//            }
//        }
//    }
